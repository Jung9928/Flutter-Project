...
class BankNovice extends StatefulWidget {
  BankNovice({Key key, this.saveIndex, this.sentencefullcount, this.uid})
      : super(key: key);
...
class _BankNoviceState extends State<BankNovice> {
          ...
          children: [
            ...
            Center(
              child: StreamBuilder<QuerySnapshot>(
                stream:
                    Firestore.instance.collection("bank_novice").snapshots(),
  ...
  void Add_Favorite(String name, String description) async {
    flutterToast();
    await Firestore.instance.collection(widget.uid + '_favorite_novice').add({
      'text': name,
