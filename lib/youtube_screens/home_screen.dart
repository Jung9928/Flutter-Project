...
import 'package:flutter_firebase_login/youtube_screens/video_screen.dart';
import 'package:flutter_firebase_login/youtube_service/api_service.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  _initChannel() async {
    Channel channel = await APIService.instance
        .fetchChannel(channelId: 'UCrtLGKxDsc9_Z2m6A195qtA');
    setState(() {
      _channel = channel;
    });
  }
